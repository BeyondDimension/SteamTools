...
namespace System.Windows
{
    ...
    public enum ResizeModeCompat
    {
        ...
        /// </summary>
        NoResize = IDesktopPlatformService.ResizeMode_NoResize,

        /// <summary>
        /// 用户只能最小化窗口并从任务栏还原。 同时显示 "最小化" 和 "最大化" 框，但只启用 "最小化" 框。
        /// </summary>
        CanMinimize = IDesktopPlatformService.ResizeMode_CanMinimize,

        /// <summary>
        /// 用户可以通过使用 "最小化" 和 "最大化" 框以及围绕窗口的可拖动轮廓来完全调整窗口的大小。 显示和启用 "最小化" 和 "最大化" 框。 (默认) 。
        /// </summary>
        CanResize = IDesktopPlatformService.ResizeMode_CanResize,

        /// <summary>
        /// 此选项具有与相同的功能 <see cref="CanResize"/> ，但会将 "调整手柄" 添加到窗口的右下角。
        /// </summary>
        [Obsolete("not implemented")]
        CanResizeWithGrip = IDesktopPlatformService.ResizeMode_CanResizeWithGrip,
    }
}