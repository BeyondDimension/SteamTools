...
//    static void SetBootAutoStartByTaskScheduler(IPlatformService platformService, bool isAutoStart, string name, string userId, string userName, string tdName, string programName)
//    {
//        if (isAutoStart)
//        {
//            using var td = TaskService.Instance.NewTask();
//            td.RegistrationInfo.Description = GetDescription(name);
