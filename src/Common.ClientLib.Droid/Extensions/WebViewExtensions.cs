...
namespace System
{
    ...
    public static class WebViewExtensions
    {
        ...
        public static bool Destroy_(this WebView? webView)
        {
            if (webView != null)
            {
                ...
                if (parent is ViewGroup group)
                    group.RemoveView(webView); // 移除WebView
...
#pragma warning restore CS0618 // 类型或成员已过时
        ...
        public static void LoadHtmlString(this WebView webView, string htmlString)
        {
