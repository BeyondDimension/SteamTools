...
namespace System.Application.Properties {
    ...
    internal class SR {
        ...
        internal static string ExitCode_IsRoot {
            get {
                return ResourceManager.GetString("ExitCode_IsRoot", resourceCulture);
            }
        }
        
        /// <summary>
        ///   查找类似 此应用不支持多开 的本地化字符串。
        /// </summary>
        internal static string ExitCode_IsVirtualApk {
            get {
                return ResourceManager.GetString("ExitCode_IsVirtualApk", resourceCulture);
            }
        }
        
        /// <summary>
        ///   查找类似 此应用不支持在装有Xposed框架的设备中运行 的本地化字符串。
        /// </summary>
        internal static string ExitCode_IsXposedExists {
            get {
                return ResourceManager.GetString("ExitCode_IsXposedExists", resourceCulture);
            }
        }
    }
}
