...
{
    public abstract partial class PlatformApplicationUpdateServiceImpl : ApplicationUpdateServiceImpl
    {
        public PlatformApplicationUpdateServiceImpl(IToast toast, ICloudServiceClient client, IOptions<AppSettings> options) : base(toast, client, options)
        {
        }
