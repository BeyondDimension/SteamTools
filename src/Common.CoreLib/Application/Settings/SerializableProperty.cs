...
namespace System.Application.Settings
{
    ...
    public class SerializableProperty<T> : INotifyPropertyChanged where T : notnull
    {
        ...
        public virtual IDisposable Subscribe(Action<T?> listener, bool notifyOnInitialValue = true)
        {
        ...
        protected class ValueChangedEventListener : IDisposable
        {
        ...
        protected readonly Dictionary<PropertyChangedEventHandler, EventHandler<ValueChangedEventArgs<T>>> _handlers = new();
