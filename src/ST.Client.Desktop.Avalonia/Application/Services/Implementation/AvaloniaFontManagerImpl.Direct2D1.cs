...
namespace System.Application.Services.Implementation
{
    partial class AvaloniaFontManagerImpl
    {
        ...
        protected virtual bool TryMatchCharacterByDirect2D1(int codepoint, FontStyle fontStyle, FontWeight fontWeight, FontFamily fontFamily, CultureInfo culture, out Typeface fontKey) => throw new NotSupportedException();
