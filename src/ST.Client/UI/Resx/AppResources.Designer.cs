...
namespace System.Application.UI.Resx {
    ...
    public class AppResources {
        ...
        /// <summary>
        ///   查找类似 「Steam++」当前版本的发布离不开大家的支持，如果Steam++有帮助到您，并且您希望我们能长久的保持新功能开发和维护，您可以考虑给我们一点捐助，以使我们更有动力的更新维护Steam++。
        ///*捐助时请记得备注上您Steam++账号的GUID在备注消息内，这样能方便我们后续将捐助奖励反馈到您的账号上。 的本地化字符串。
        /// </summary>
