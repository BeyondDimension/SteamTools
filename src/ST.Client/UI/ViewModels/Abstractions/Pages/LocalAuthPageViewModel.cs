...
using AuthService = System.Application.Services.Abstractions.AuthService;
...
namespace System.Application.UI.ViewModels.Abstractions
{
    public partial class LocalAuthPageViewModel
    {
        ...
        protected abstract ShowAuthWindowViewModel GetShowAuthWVM(MyAuthenticator auth);

        protected abstract AuthTradeWindowViewModel GetAuthTradeWVM(MyAuthenticator auth);
