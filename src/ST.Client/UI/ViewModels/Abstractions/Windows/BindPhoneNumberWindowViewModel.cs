...
{
    public abstract class BindPhoneNumberWindowViewModel : WindowViewModel, SendSmsUIHelper.IViewModel
    {
        public static string DisplayName => AppResources.User_BindPhoneNum;

        public BindPhoneNumberWindowViewModel()
        {
