...
{
    public abstract partial class AuthTradeWindowViewModel : MyAuthenticatorWindowViewModel
    {
        ...
        /// 是否加载确认物品图片
        /// </summary>
        protected abstract bool IsLoadImage { get; }

        /// <summary>
        /// 注册全选监听
        /// </summary>
        protected abstract void RegisterSelectAllObservable();
