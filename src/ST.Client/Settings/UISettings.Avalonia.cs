...
namespace System.Application.Settings
{
    partial class UISettings
    {
        ...
        static readonly SerializableProperty<int>? _WindowBackgroundMateria = IApplication.IsDesktopPlatform ? GetProperty(defaultValue: OperatingSystem2.IsWindows7 ? 0 : (OperatingSystem2.IsWindows11AtLeast ? 5 : 3), autoSave: true) : null;
