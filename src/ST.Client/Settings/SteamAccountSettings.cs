...
namespace System.Application.Settings
{
    public sealed class SteamAccountSettings : SettingsHost2<SteamAccountSettings>
    {
        ...
        /// Steam账号备注字典
        /// </summary>
        public static SerializableProperty<ConcurrentDictionary<long, string?>> AccountRemarks { get; }
            = Compat.GetProperty(defaultValue: new ConcurrentDictionary<long, string?>(), autoSave: false);
