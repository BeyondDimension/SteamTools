...
namespace System.Application.Settings
{
    ...
    public sealed class SteamAccountSettings : SettingsHost2<SteamAccountSettings>
    {
        ...
        readonly static SerializableProperty<ConcurrentDictionary<long, string?>>? _AccountRemarks = OperatingSystem2.Application.UseAvalonia ? Compat.GetProperty(defaultValue: new ConcurrentDictionary<long, string?>(), autoSave: false) : null;
        /// <summary>
        /// Steam账号备注字典
        /// </summary>
