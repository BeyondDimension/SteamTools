...
{
    internal sealed class ProxySettings : Abstractions.ProxySettings<ProxySettings>
    {
...
{
    public abstract class ProxySettings<TSettings> : SettingsHost2<TSettings> where TSettings : ProxySettings<TSettings>, new()
    {
        /// <summary>
        /// 启用脚本自动检查更新
        /// </summary>
