...
using System.Xml;
using WinAuth;
using static System.Application.Services.Abstractions.AuthService;

namespace System.Application.Models.Abstractions
{
    public abstract class MyAuthenticator : ReactiveObject
    {
        ...
        protected MyAuthenticator(IGAPAuthenticatorDTO data)
        {
        ...
        public Task<Stream?> GetQrCodeStream() => GetQrCodeStreamAsync(AuthenticatorData);
