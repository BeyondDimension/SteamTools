...
sealed class SteamServiceImpl : ISteamService
{
    ...
    public SteamServiceImpl(IPlatformService platformService)
    {
        ...
        mRegistryVdfPath = platformService.GetRegistryVdfPath();
    ...
    public void StartSteam(string? arguments = null)
    {
        ...
        {
            if (OperatingSystem.IsWindows() && !SteamSettings.IsRunSteamAdministrator.Value)
            {
    ...
    public void SetCurrentUser(string userName) => platformService.SetSteamCurrentUser(userName);
