...
namespace System.Application.Services.Implementation
{
    ...
    public class PermissionsImpl : IPermissions
    {
        ...
        protected virtual void PromptUserGoToSettings(IPermissions.IPermission permission)
        {
        ...
        /// </summary>
        /// <param name="permission"></param>
        protected virtual void ShowRationale(IPermissions.IPermission permission)
        {
            // 可由平台重写此函数实现，通常为显示一个吐司消息，因调用此函数后会立即开始重新申请权限
        }

        public async Task<PermissionStatus> CheckAndRequestAsync(IPermissions.IPermission permission)
        {
