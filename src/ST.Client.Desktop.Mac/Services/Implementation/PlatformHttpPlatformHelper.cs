...
namespace System.Application.Services.Implementation
{
    internal sealed class PlatformHttpPlatformHelper : DesktopHttpPlatformHelper
    {
        ...
        {
            var value = $"Mozilla/5.0 (Macintosh; Intel Mac OS X; {Environment.OSVersion.Version.Major}_{Environment.OSVersion.Version.Minor}_{Environment.OSVersion.Version.Build}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.72 Safari/537.36";
            return value;
        });
