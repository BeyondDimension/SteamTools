...
namespace System.Application.Services.CloudService
{
    partial class MockCloudServiceClient
    {
        public Task<IApiResponse<List<ScriptDTO>>> Scripts()
        {
            ...
            return Task.FromResult<IApiResponse<List<ScriptDTO>>>(ApiResponse.Ok(list));
        }
        ...
        public Task<IApiResponse<List<AccelerateProjectGroupDTO>>> All()
        {
            ...
            return Task.FromResult<IApiResponse<List<AccelerateProjectGroupDTO>>>(ApiResponse.Ok(list));
        }
    }
}
#endif