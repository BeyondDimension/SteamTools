...
public sealed partial class GameLibrarySettings : SettingsHost2<GameLibrarySettings>
{
    ...
    static readonly SerializableProperty<List<SteamAppType>>? _GameTypeFiltres = IApplication.IsDesktop() ? GetProperty(defaultValue: new List<SteamAppType> { SteamAppType.Game, SteamAppType.Application, SteamAppType.Demo, SteamAppType.Beta }) : null;
    ...
    static readonly SerializableProperty<Dictionary<uint, string?>>? _HideGameList = IApplication.IsDesktop() ? GetProperty(defaultValue: new Dictionary<uint, string?>()) : null;
    ...
    static readonly SerializableProperty<Dictionary<uint, string?>?>? _AFKAppList = IApplication.IsDesktop() ?
        GetProperty<Dictionary<uint, string?>?>(defaultValue: null) : null;
    ...
    static readonly SerializableProperty<bool>? _IsAutoAFKApps
        = IApplication.IsDesktop() ? GetProperty(defaultValue: true) : null;
    ...
    // [SupportedOSPlatform("macOS")]
    // [SupportedOSPlatform("Linux")]
    // public static readonly Lazy<ReadOnlyCollection<uint>>? DefaultIgnoreList = IApplication.IsDesktop() ? new(new ReadOnlyCollection<uint>(new uint[]
    // {
    //     5,
    //     7,
    //     8,
