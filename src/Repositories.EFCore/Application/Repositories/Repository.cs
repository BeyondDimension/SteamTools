...
namespace System.Application.Repositories
{
        ...
        where TEntity : class
    {
        ...
        readonly IHttpContextAccessor mHttpContextAccessor;
        ...
        static readonly Lazy<bool> mIsSoftDeleted = new(() => ModelBuilderExtensions.IsSoftDeleted(entityType));

        public static bool IsSoftDeleted => mIsSoftDeleted.Value;

        protected CancellationToken RequestAborted => mHttpContextAccessor.HttpContext?.RequestAborted ?? default;

        CancellationToken IEFRepository<TEntity>.RequestAborted => RequestAborted;

        public Repository(TDbContext dbContext, IHttpContextAccessor httpContextAccessor) : base(dbContext)
        {
        ...
        where TPrimaryKey : IEquatable<TPrimaryKey>
    {
        ...
        public Repository(TDbContext dbContext, IHttpContextAccessor httpContextAccessor) : base(dbContext, httpContextAccessor)
        {
