...
namespace System.Application.Internals.Certs
{
    ...
    static class CertGenerator
    {
        ...
        public static X509Certificate2 GenerateByCaPfx(IEnumerable<string> domains, int keySizeBits, DateTime validFrom, DateTime validTo, string caPfxPath, string? password = default)
        {
            ...
            var ca = new X509Certificate2(caPfxPath, password, System.Security.Cryptography.X509Certificates.X509KeyStorageFlags.Exportable);
        ...
        /// <param name="cert"></param>
        /// <returns></returns>
        private static string GetSubjectName(X509Certificate2 cert)
        {
